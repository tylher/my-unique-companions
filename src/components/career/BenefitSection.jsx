  ...
  return (
    <section className="relative overflow-hidden bg-primary-container py-16">
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-6">
        ...
        >
          <p className="mb-4 text-sm font-semibold uppercase tracking-[0.25em] font-body text-[#fd7137]">
            Benefits & Perks
          </p>
          <h2 className="mb-4 font-display text-4xl text-white md:text-5xl">
            Benefits That Value Your Contribution
          </h2>
          <p className="mx-auto max-w-2xl text-[#bac3ff] font-body">
        ...
        >
          {benefits.map((benefit) => {
            ...
            return (
              ...
              >
                <motion.div
                  className="mb-5 flex h-10 w-10 items-center justify-center rounded-xl bg-white/10"
                ...
                <h3 className="mb-3 text-lg font-semibold font-display text-white">
                  {benefit.title}
                </h3>
                <p className="text-[#bac3ff] font-body">
                  {benefit.description}
                </p>
              </motion.div>
            );
