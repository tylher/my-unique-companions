...
const Mission = () => {
  return (
    <section className="relative bg-primary-container py-16 md:py-24 overflow-hidden">
      ...
      >
        <span className="text-[#e35e25] uppercase text-center mb-8 md:mb-10 font-bold text-base md:text-lg inline-block font-body">
          Our Mission
        </span>
        ...
        <div className="w-24 h-px bg-[#e35e25] mx-auto mt-6 md:mt-7" />
      </motion.div>
