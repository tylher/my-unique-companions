  ...
  return (
    <section className="relative overflow-hidden bg-surface-container-low py-12 md:py-16">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        >
          <h2 className="font-display font-semibold text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-primary mb-8 md:mb-12 mx-auto text-center leading-tight">
            A Home That Feels Like Family
          </h2>
        </motion.div>

        <div className="relative">
          {/* Center journey line — lg only */}
          ...
          <div className="flex flex-col gap-8 md:gap-10">
            {statements.map((item, index) => {
              ...
              return (
                ...
                >
                  {/* Timeline marker — lg only */}
                  <motion.div
                    initial={{ scale: 0 }}
                    whileInView={{ scale: 1 }}
                    viewport={{ once: true }}
                    transition={{ duration: 0.5, delay: index * 0.15 }}
                    className="hidden lg:flex absolute left-1/2 -translate-x-1/2 top-6 z-10"
                  >
                  ...
                  >
                    ...
                    <motion.div
                      ...
                      className="flex gap-2 mb-4 md:mb-5"
                    >
                    ...
                    <motion.h3
                      ...
                      className="font-display font-semibold text-2xl sm:text-3xl md:text-4xl text-primary leading-tight mb-4 md:mb-5"
                    >
                      {item.title}
                    </motion.h3>
                    ...
                    <motion.p
                      ...
                      className="max-w-md text-on-surface-variant leading-relaxed text-sm sm:text-base"
                    >
                      {item.description}
                    </motion.p>
                  </motion.div>
